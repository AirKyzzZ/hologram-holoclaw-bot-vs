...
export class ChatbotService {
   ...
   *
   * @param userInput The raw user message/question from the user.
   * @param connectionId Unique session or user identifier.
   * @returns The agent's reply as generated by the LLM.
   */
  async chat(userInput: string, connectionId: string): Promise<string> {
